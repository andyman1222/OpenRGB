...
public:
    ...
    | PluginManager APIs                                    |
    \*-----------------------------------------------------*/
    virtual void                                    RegisterRGBController(RGBControllerInterface* controller)                           = 0;
    virtual void                                    RegisterRGBControllerInThread(RGBControllerInterface* controller)                   = 0;
    virtual void                                    UnregisterRGBController(RGBControllerInterface* controller)                         = 0;
    virtual void                                    UnregisterRGBControllerInThread(RGBControllerInterface* controller)                 = 0;
