...
public:
    ...
    | PluginManager APIs                                    |
    \*-----------------------------------------------------*/
    void                                    RegisterRGBController(RGBControllerInterface * rgb_controller);
    void                                    RegisterRGBControllerInThread(RGBControllerInterface * rgb_controller);
    void                                    UnregisterRGBController(RGBControllerInterface * rgb_controller);
    void                                    UnregisterRGBControllerInThread(RGBControllerInterface * rgb_controller);
